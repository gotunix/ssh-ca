...
class SSHCAReporter:
    ...
    def generate_html_report(self, data: Dict) -> str:
        ...
        if user_template_file.exists():
            ...
            # If bundled template is missing, this is a critical installation issue
            # But we can try to return a very basic error page instead of crashing
            return """
            <html><body><h1>Template Not Found</h1>
            <p>Could not find <code>sshca_report_template.html</code>
            in reports directory or package.</p>
            </body></html>
            """
